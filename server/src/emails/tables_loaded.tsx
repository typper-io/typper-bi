...
interface TablesLoadedEmailProps {
  dataSourceTablesLink?: string
  dataSourceName?: string
}

export const TablesLoadedEmail = ({
  dataSourceTablesLink,
  dataSourceName,
}: TablesLoadedEmailProps) => (
  <Html>
    <Head />
    <Preview>Your Typper tables loaded</Preview>
    <Tailwind>
        ...
        <Container>
          ...
          <Section className="mt-8">
            <Text className="text-base leading-8 text-[#020817]">
              The tables from the data source {dataSourceName} have been loaded.
              You can now continue with the addition.
            </Text>
            <Button
              href={dataSourceTablesLink}
              className="bg-[#2563EB] text-[#F8FAFC] text-center rounded-md py-2 px-4 mt-4"
            >
              Continue to review tables
            </Button>
